...
//         priceId: "price_1RewXxB3VaDYwKFkU9Wl1ah4",
//     },
//     {
//         id: 'standard',
//         name: 'Standard',
//         price: '$9.99',
//         features: ['HD available', 'Watch on any device', 'No ads', 'Cancel anytime'],
//         // priceId: process.env.NEXT_PUBLIC_STANDARD_PLAN_PRICE_ID,
//         priceId: "price_1RewbaB3VaDYwKFk0ycWqrRn",
//     },
//     {
//         id: 'premium',
//         name: 'Premium',
//         price: '$14.99',
//         features: ['Ultra HD', 'Watch on any device', 'No ads', 'Download videos', 'Cancel anytime'],
//         // priceId: process.env.NEXT_PUBLIC_PREMIUM_PLAN_PRICE_ID,
//         priceId: "price_1RewhnB3VaDYwKFksqTgepDh",
//     },
// ];
...
//         setLoading(true);
//         try {
//             console.log("AAASSSSS====",priceId)
//             const { data } = await axios.post(`http://localhost:5000/create-checkout-session/${auth.user._id}`, {
//                 priceId,
//             });
...
//                     <div
//                         key={plan.id}
//                         className={`rounded-lg shadow-lg overflow-hidden ${selectedPlan === plan.id ? 'ring-2 ring-blue-500' : ''
//                             }`}
//                     >
...
//                                 <span className="px-3 py-1 text-4xl font-bold text-white">
//                                     {plan.price}
//                                 </span>
...
//                                 className={`w-full px-6 py-3 rounded-md text-white font-medium ${loading
//                                         ? 'bg-gray-500'
...
const PricingPage = () => {
    ...
    const handleCheckout = async (planId) => {
        try {
            const res = await axios.post(`http://localhost:5000/payment/create-checkout-session/${auth.user._id}`, {
                planId: planId,
